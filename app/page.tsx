          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
                ...
                <span className="font-mono text-slate-700 text-sm">{fallbackIP}</span>
              </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-slate-500">If the primary address doesn't work, try the fallback:</p>
                      <code className="bg-slate-100 px-3 py-2 rounded-lg font-mono text-sm text-slate-600 mt-1 block">
                        {fallbackIP}
                      </code>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="border-0 bg-white/60 backdrop-blur-sm shadow-sm rounded-2xl">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-slate-500 font-light">fallback ip</span>
                <code className="font-mono text-sm text-slate-600">{fallbackIP}</code>
              </div>
              <div className="flex justify-between items-center">
            ...
            {!serverStatus.online ? (
              ...
              <div className="text-center py-12">
                ...
                <div className="mt-6">
                  ...
                  <p className="text-xs text-slate-500 mt-2 text-center">Fallback: {fallbackIP}</p>
                </div>
              </div>
            )}
          </CardContent>
...
<footer className="bg-slate-800 text-slate-300 py-8 px-4">
  <div className="max-w-7xl mx-auto text-center space-y-4">
    ...
    <p className="text-sm font-mono text-blue-200">Fallback: {fallbackIP}</p>
  </div>
</footer>
