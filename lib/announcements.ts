...
const announcementsData: Announcement[] = [
      ...
      id: "announcement-9",
    title: "Big changes",
    body: "Updated game to 1.21.11 and added bedrock support. Added many more plugins and datapacks, Added Voxy support. Replaced coreprotect with backuper for automated backups",
    date: "2026-4-12",
  },
          {
      id: "announcement-8",
