...
**Effective Date:** Upon creation of a Callen Industries (CI) account or first use of any CI service  
**Entity:** Callen Industries, including subsidiaries Innovative Postal (IP) and Callen Security Industries (CSI) (“Callen Industries,” “we,” “us,” or “our”)  

These Terms & Conditions govern all services provided by Callen Industries and its subsidiaries. By creating a CI account or using any CI service, you (“Client,” “Customer,” or “You”) agree to be bound by these terms.  
...
Additional service-specific details may be defined in service agreements or insurance documentation.  
...
- During the meeting, CI will document all claim details.  
- Damage or loss will be assessed in-game within several days depending on availability.  
- Insurance coverage amounts and limits are specified in the CI Insurance Spreadsheet.  
...
- Server crashes, rollbacks, lag, plugin bugs, dupe wipes, or technical issues outside our control.  
...
**Important:** CI is not liable for loss of items in storage unless the items are explicitly insured.  

CI may voluntarily assist in excluded cases but is not obligated to do so.  
...
- CI is no longer liable for theft, griefing, or loss after delivery confirmation.  
...
- On other servers/realms, CI will use the local postal system or mutually agreed delivery drop-off point.  
...
- Provide accurate and honest information, including usernames, Discord IDs, email addresses, and occasionally phone numbers.  
- Maintain lawful and proper use of CI services.  
- Report changes affecting service or insurance needs.  
...
**No Refunds Policy:** All payments are final; no refunds will be issued under any circumstances.  

---

## 10. Payment and Billing
- Payments must follow the agreed schedule.  
- Late payments may incur additional fees or result in suspended services.  
- Continued non-payment may lead to service termination.  
- Prices are listed in invoices; it is the Client’s responsibility to review before payment.  

---

## 11. Privacy and Confidentiality
We collect and store Client information including usernames, Discord IDs, email addresses, and occasionally phone numbers.  
...
## 13. Amendments
Callen Industries may update these Terms at any time. Continued use of services constitutes acceptance of updated Terms.  
...
Callen Industries may assign or subcontract tasks to authorized CI staff or trusted third-party partners. All personnel acting on behalf of CI operate under CI supervision and are expected to follow the same conduct and confidentiality requirements.  
...
- Attempt resolution first through a meeting with CI staff.  
- If no agreement is reached, final interpretation may be made by:  
